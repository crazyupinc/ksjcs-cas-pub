...
const FindPw: NextPage = () => {
  return (
    <div className="w-full relative bg-colors-blue-50 flex flex-col items-center justify-center p-[1.25rem] box-border text-left text-[0.875rem] text-text-text-small-light font-headings-heading-3">
