...
const FindFormTest: NextPageFindFormTestType = () => {
  return (
    <div className="w-full relative bg-text-gray flex flex-row items-center justify-center p-[0.625rem] box-border text-left text-[0.875rem] text-text-text-small-light font-body-text-smaller-text">
