...
const FindFormTest: NextPageFindFormTestType = () => {
  return (
    <div className="w-full relative bg-text-gray flex flex-row items-center justify-center p-[0.625rem] box-border text-left text-[0.875rem] text-text-text-small-light font-sub-banner-title">
      <div className="flex-1 rounded-xl bg-button-colors-white flex flex-col items-center justify-start py-[2.25rem] px-[1rem] box-border gap-[2.5rem] max-w-[37.5rem]">
