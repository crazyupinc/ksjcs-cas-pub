...
const Index1: NextPage = () => {
  return (
    <div className="w-full relative bg-button-colors-white overflow-hidden flex flex-col items-start justify-start p-[2.5rem] box-border gap-[1.25rem] text-left text-[2.25rem] text-black font-headings-headling-2">
