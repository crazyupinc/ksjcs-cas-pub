...
const HeaderLayout: NextPageHeaderLayoutType = () => {
  return (
    <div className="w-full relative bg-bg-colors-light-gray flex flex-col items-start justify-start text-left text-[0.875rem] text-text-colors-normal font-sub-banner-title">
