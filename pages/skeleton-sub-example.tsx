  ...
  return (
    <div className="w-full relative flex flex-col items-start justify-start text-left text-[1.875rem] text-text-colors-normal font-headings-headling-2">
            ...
            <div className="w-full flex-1 flex flex-row items-center justify-between py-[0rem] px-[0.937rem] box-border max-w-[81.25rem]">
              <div className="w-[20.313rem] flex flex-row items-center justify-start">
                <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-col items-start justify-center">
                  <img
                    className="w-[8.625rem] relative h-[2.5rem] object-cover mq350small:w-[6.438rem] mq350small:h-[1.875rem]"
                    alt="CyberComLogo"
                    loading="eager"
      ...
      <div className="self-stretch bg-colors-indigo-300 h-[11.25rem] flex flex-col items-center justify-start sm:h-[7.5rem]">
        <div className="w-[120rem] bg-button-colors-white h-[11.25rem] flex flex-col items-center justify-center py-[3.125rem] px-[1.25rem] box-border">
