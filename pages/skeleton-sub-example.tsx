...
const SkeletonSubExample: NextPage = () => {
  ...
  return (
    <div className="w-full relative flex flex-col items-start justify-start text-left text-[2.25rem] text-text-colors-amber font-headings-heading-4">
      ...
      <div className="self-stretch bg-colors-green-300 flex flex-col items-center justify-start text-center">
