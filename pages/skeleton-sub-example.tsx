...
const SkeletonSubExample: NextPage = () => {
  ...
  return (
    <div className="w-full relative flex flex-col items-start justify-start text-left text-[2.25rem] text-text-colors-amber font-headings-heading-3">
      <div className="self-stretch bg-colors-red-300 h-[7.75rem] flex flex-col items-center justify-start md:h-[4.375rem]">
        <div className="self-stretch flex-1 bg-text-colors-dark-gray flex flex-row items-center justify-center p-[0.625rem]">
          <div className="w-[81.25rem] flex flex-row flex-wrap items-center justify-between max-w-[81.25rem]">
            <b className="w-[12.5rem] relative text-[3rem] leading-[3rem] flex items-center shrink-0 md:text-[2.25rem]">
              LOGO
            </b>
            <div className="flex-1 flex flex-row items-center justify-between text-center">
              <b className="w-[7.5rem] relative leading-[2.5rem] flex items-center justify-center shrink-0 md:hidden">
                menu
              </b>
              <b className="w-[7.5rem] relative leading-[2.5rem] flex items-center justify-center shrink-0 md:hidden">
                menu
            ...
            <b className="w-[2.125rem] relative leading-[2.5rem] hidden text-right md:flex">
              ☰
            </b>
          </div>
        </div>
      </div>
      <div className="self-stretch bg-colors-blue-300 h-[13.75rem] flex flex-col items-center justify-start text-center text-[3rem] text-bg-colors-white sm:h-[10.625rem]">
        <div className="self-stretch flex-1 flex flex-col items-center justify-end bg-[url('/subbanner@3x.png')] bg-cover bg-no-repeat bg-[top] mix-blend-normal">
      ...
      <div className="self-stretch bg-bg-colors-white flex flex-col items-center justify-start min-h-[31.25rem] text-[1.875rem] text-black">
      ...
      <div className="self-stretch bg-colors-green-300 flex flex-col items-center justify-start min-h-[13.125rem] text-center">
        <div className="self-stretch bg-text-colors-dark-gray flex flex-col items-center justify-start p-[0.625rem]">
