...
const SkeletonSubExample: NextPage = () => {
  return (
    <div className="w-full relative flex flex-col items-start justify-start text-left text-[1.875rem] text-text-colors-normal font-navbar-sub-item">
              ...
              <div className="self-stretch flex flex-row items-center justify-start gap-[1rem]">
                <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-row items-center justify-start gap-[0.25rem]">
                  <img
                    ...
                    src="/iconlogin.svg"
                  />
                  <div className="w-[2.788rem] relative text-[0.875rem] leading-[1.25rem] font-navbar-sub-item text-text-colors-normal text-left flex items-center h-[1.4rem] shrink-0 hover:text-button-colors-dark-sky">
                    {" "}
                    로그인
                  </div>
                </button>
                <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-row items-center justify-start gap-[0.25rem]">
                  ...
                  />
                  <div className="w-[3.625rem] relative text-[0.875rem] leading-[1.25rem] font-navbar-sub-item text-text-colors-normal text-left flex items-center h-[1.4rem] shrink-0 hover:text-button-colors-dark-sky">
                    {" "}
                    회원가입
                  </div>
                </button>
              ...
              <div className="self-stretch flex-1 flex flex-row items-center justify-between md:hidden">
                <div className="self-stretch flex-1 flex flex-col items-center justify-start">
                  <button className="cursor-pointer [border:none] pt-spacing-5 px-spacing-0-5 pb-spacing-7 bg-[transparent] self-stretch flex-1 flex flex-col items-center justify-start">
                    <b className="self-stretch relative text-[1.125rem] leading-[1.25rem] font-navbar-sub-item text-text-colors-normal text-center hover:text-button-colors-dark-sky">
                      학회 소개
                    </b>
                  </button>
                </div>
              ...
              <div className="flex-1 flex flex-row items-start justify-between">
                <div className="flex-1 flex flex-col items-center justify-start">
                  <button className="cursor-pointer [border:none] py-spacing-2-5 px-spacing-0-5 bg-[transparent] self-stretch flex flex-col items-center justify-center">
                    <div className="self-stretch relative text-[0.875rem] leading-[1.25rem] font-navbar-sub-item text-text-colors-normal text-center hover:text-button-colors-dark-sky">
                      회장인사말
                    </div>
                  </button>
                  <button className="cursor-pointer [border:none] py-spacing-2-5 px-spacing-0-5 bg-[transparent] self-stretch flex flex-col items-center justify-center">
