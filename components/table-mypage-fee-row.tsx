...
const TableMypageFeeRow: NextPage = () => {
  return (
    <div className="w-[1300px] max-w-full overflow-hidden flex flex-col items-center justify-center min-w-[300px] text-center text-sm text-text-title-small font-headings-headling-2 sm:flex">
