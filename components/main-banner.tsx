...
const MainBanner: NextPage<MainBannerType> = ({ className = "" }) => {
  return (
    <div
      className={`w-full h-[600px] max-w-full flex flex-row items-center justify-center py-[120px] px-0 box-border bg-[url('/mainbanner@3x.png')] bg-cover bg-no-repeat bg-[top] text-right text-17xl text-bg-white font-body-text-small-text-bold md:h-[400px] sm:h-[400px] mq420:h-[400px] ${className}`}
    >
