...
const TableBbsDataRow: NextPage<TableBbsDataRowType> = ({
  ...
  return (
    <div
      className={`box-border max-w-full overflow-hidden flex flex-row items-center justify-start py-3 px-5 gap-[20px] min-w-[320px] text-center text-sm text-text-gray font-sub-banner-title self-stretch border-b-[1px] border-solid border-bg-light-border hover:bg-bg-light sm:flex-col sm:gap-[8px] sm:items-start sm:justify-center mq420:min-w-[300px] ${className}`}
    >
      <div className="flex-1 overflow-hidden flex flex-row items-start justify-start gap-[20px] sm:pt-0 sm:pb-0 sm:box-border sm:flex-[unset] sm:self-stretch">
        ...
        <div className="flex-1 flex flex-row items-start justify-start gap-[4px] text-left text-button-colors-dark-sky">
          ...
          <div className="flex flex-col items-start justify-start py-0.5 px-0 text-xs text-button-colors-white">
