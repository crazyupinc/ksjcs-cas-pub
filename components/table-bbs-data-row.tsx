...
const TableBbsDataRow: NextPage<TableBbsDataRowType> = ({
  ...
  return (
    <div className="box-border max-w-full overflow-hidden flex flex-row items-center justify-start py-3 px-5 gap-[20px] min-w-[320px] text-center text-sm text-text-gray font-headings-headling-2 self-stretch border-b-[1px] border-solid border-bg-light-border hover:bg-bg-light sm:flex-col sm:gap-[8px] sm:items-start sm:justify-center mq420:min-w-[300px]">
