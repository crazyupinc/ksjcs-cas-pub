...
const TableMypageInputRow: NextPage<TableMypageInputRowType> = ({
  ...
  return (
    <div
      className={`w-[900px] max-w-full overflow-hidden flex flex-col items-start justify-center min-w-[200px] text-left text-sm text-text-title-small font-sub-banner-title hover:bg-bg-light lg:bg-button-colors-white sm:flex-col ${className}`}
    >
