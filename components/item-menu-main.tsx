...
const ItemMenuMain: NextPage<ItemMenuMainType> = ({ title }) => {
  return (
    <button className="cursor-pointer [border:none] pt-spacing-4 px-spacing-0-5 pb-spacing-8 bg-[transparent] flex flex-col items-center justify-start box-border self-stretch flex-1">
