...
const MainContent: NextPage = () => {
  return (
    <div className="w-[1920px] bg-bg-colors-white max-w-full flex flex-col items-center justify-start py-[120px] px-5 box-border gap-[24px] text-center text-base text-text-light-gray font-headings-headling-2 sm:pl-0 sm:pr-0 sm:box-border mq420:pl-0 mq420:pr-0 mq420:box-border">
      <div className="w-full bg-bg-colors-white overflow-hidden flex flex-col items-center justify-start gap-[46px] max-w-[1300px]">
        <div className="self-stretch flex flex-col items-center justify-start gap-[6px]">
          <b className="self-stretch relative leading-[24px] mq420:text-2xs">
        ...
        <div className="self-stretch flex flex-row items-start justify-start gap-[22px] text-left text-text-title-small-light md:flex-col">
          <div className="flex-1 flex flex-col items-start justify-start md:flex-[unset] md:self-stretch">
            <div className="self-stretch rounded bg-bg-colors-light-gray overflow-hidden flex flex-col items-center justify-start p-5 gap-[20px] sm:pl-5 sm:box-border mq420:p-5 mq420:box-border">
              <img
              ...
              <div className="self-stretch h-[90px] flex flex-col items-start justify-start gap-[6px]">
                ...
                <div className="self-stretch relative text-sm leading-[24px] font-sub-sub-item [display:-webkit-inline-box] overflow-hidden text-ellipsis [-webkit-line-clamp:2] [-webkit-box-orient:vertical] mq420:text-xs">
          ...
          <div className="flex-1 flex flex-col items-center justify-start gap-[20px] md:flex-[unset] md:self-stretch mq420:gap-[8px]">
            <div className="self-stretch rounded bg-bg-colors-light-gray h-[171px] overflow-hidden shrink-0 flex flex-row items-start justify-center p-5 box-border gap-[22px] mq420:gap-[16px] mq420:p-5 mq420:box-border">
              <img
              ...
              <div className="flex-1 h-[131px] overflow-hidden flex flex-col items-start justify-start gap-[6px]">
                ...
                <div className="self-stretch relative text-sm leading-[24px] font-sub-sub-item [display:-webkit-inline-box] overflow-hidden text-ellipsis [-webkit-line-clamp:4] [-webkit-box-orient:vertical] mq420:text-xs">
                  3줄 이상의 컨텐츠 -2024 봄철 정기학술대회를 진행하였습니다.
                  2024 봄철 정기학술대회를 진행하였습니다. 2024 봄철
                  정기학술대회를 진행하였습니다. 2024 봄철 정기학술대회를
                  진행하였습니다.2024 봄철 정기학술대회를 진행하였습니다. 2024
            ...
            <div className="self-stretch rounded bg-bg-colors-light-gray h-[171px] overflow-hidden shrink-0 flex flex-row items-start justify-center p-5 box-border gap-[22px] sm:pl-[22px] sm:box-border mq420:gap-[16px] mq420:p-5 mq420:box-border">
              <img
                className="self-stretch flex-1 relative rounded-10xs max-w-[240px] overflow-hidden max-h-full object-cover sm:w-[100%!important] sm:h-[auto!important]"
                alt=""
                src="/img1@2x.png"
