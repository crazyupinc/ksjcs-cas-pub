...
> = ({
  ...
  return (
    <div
      className={`max-w-full overflow-hidden flex flex-col items-start justify-center min-w-[200px] text-left text-sm text-text-title-small font-body-text-smaller-text self-stretch hover:bg-bg-light lg:bg-bg-white sm:flex-col ${className}`}
    >
