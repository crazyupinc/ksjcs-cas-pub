...
const MainContent2: NextPage<MainContent2Type> = ({ className = "" }) => {
  return (
    <div
      className={`w-full bg-bg-white max-w-full flex flex-col items-center justify-start py-[110px] px-5 box-border gap-[36px] text-center text-17xl text-text-title-medium font-body-text-small-text-bold ${className}`}
    >
      ...
      <div className="flex flex-row items-center justify-start gap-[12px] border-b-[1px] border-solid border-bg-light-border">
        <button className="cursor-pointer [border:none] p-0 bg-[transparent] self-stretch flex flex-col items-center justify-center">
          <b className="self-stretch flex-1 relative text-sm leading-[20px] flex font-body-text-small-text-bold text-text-dark-gray text-center items-center justify-center">
            공지사항
          </b>
          <div className="self-stretch relative bg-bg-primary h-0.5" />
        </button>
        <button className="cursor-pointer [border:none] p-0 bg-[transparent] self-stretch flex flex-col items-center justify-center">
          <div className="self-stretch flex-1 relative text-sm leading-[20px] font-body-text-small-text-bold text-text-gray text-center flex items-center justify-center">
            주요행사
          </div>
        </button>
        <button className="cursor-pointer [border:none] p-0 bg-[transparent] self-stretch flex flex-col items-center justify-center">
      ...
      <div className="w-full flex flex-row items-start justify-center gap-[18px] max-w-[1300px] text-sm text-bg-white md:flex-col md:items-center md:justify-center md:pl-10 md:pr-10 md:box-border mq420:pl-0 mq420:pr-0 mq420:box-border">
        <div className="w-[420px] flex flex-col items-start justify-start py-5 px-0 box-border gap-[18px] min-w-[300px] md:self-stretch md:w-auto">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[16px] text-left text-xs text-text-text-small-light">
            ...
            <div className="self-stretch relative text-sm leading-[20px] [display:-webkit-inline-box] overflow-hidden text-ellipsis [-webkit-line-clamp:2] [-webkit-box-orient:vertical]">
