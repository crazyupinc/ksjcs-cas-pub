...
const TermsPopup: NextPage = () => {
  return (
    <div className="w-[700px] max-w-full flex flex-col items-start justify-start text-center text-lg text-text-title-small-light font-headings-headling-2">
      ...
      <div className="self-stretch rounded-t-none rounded-b-lg bg-bg-colors-white flex flex-row items-start justify-start p-5">
