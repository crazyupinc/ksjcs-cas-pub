...
const PageTitle: NextPage = () => {
  return (
    <div className="w-[1920px] bg-button-colors-white max-w-full h-[180px] flex flex-col items-center justify-center py-[50px] px-5 box-border text-left text-11xl text-text-colors-normal font-navbar-sub-item">
