...
const SubBanner: NextPage = () => {
  ...
  return (
    <div className="w-[1440px] max-w-full h-[220px] flex flex-col items-center justify-end bg-[url('/subbanner@3x.png')] bg-cover bg-no-repeat bg-[top] mix-blend-normal text-center text-29xl text-bg-colors-white font-headings-heading-4">
