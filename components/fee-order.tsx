...
const FeeOrder: NextPage = () => {
  return (
    <div className="w-[1920px] bg-bg-colors-white max-w-full flex flex-col items-start justify-start p-5 box-border text-left text-sm text-text-text-small-light font-headings-headling-2">
