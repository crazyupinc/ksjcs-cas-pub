          ...
          <div className="self-stretch flex flex-row items-center justify-start gap-[16px]">
            <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-row items-center justify-start gap-[4px]">
              <img
                ...
                src="/iconlogin.svg"
              />
              <div className="w-[44.6px] relative text-sm leading-[20px] font-sub-banner-title text-text-text-small-light text-left flex items-center h-[22.4px] shrink-0 hover:text-button-colors-dark-sky">
                {" "}
                로그인
              </div>
            </button>
            <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-row items-center justify-start gap-[4px]">
              ...
              />
              <div className="w-[58px] relative text-sm leading-[20px] font-sub-banner-title text-text-text-small-light text-left flex items-center h-[22.4px] shrink-0 hover:text-button-colors-dark-sky">
                {" "}
                회원가입
              </div>
            </button>
