                ...
                <div className="flex-1 flex flex-row items-center justify-start py-0.5 px-0 gap-[140px] md:gap-[100px] sm:flex-col sm:gap-[8px] mq420:gap-[8px]">
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start text-dark-gray font-text-medium sm:flex-[unset] sm:self-stretch">
                    <div className="self-stretch flex flex-col items-start justify-start gap-[6px]">
                      ...
                      <div className="self-stretch relative text-xs leading-[16px] font-headings-headling-2 text-semantic-warning mq420:text-2xs">{`* 6~20자의 영문 소/대문자(a-zA-Z) 또는 숫자(0-9) 또는 특수문자(~!@#$%^&*_-+=\`:;,.?/)`}</div>
                    </div>
                  </div>
                </div>
              </div>
