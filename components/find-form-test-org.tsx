...
const FindFormTestOrg: NextPage<FindFormTestOrgType> = ({ className = "" }) => {
  return (
    <div
      className={`w-[492px] bg-text-gray max-w-full overflow-hidden flex flex-col items-center justify-center p-2.5 box-border text-left text-sm text-text-text-small-light font-headings-heading-3 ${className}`}
    >
