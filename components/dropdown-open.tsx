...
const DropdownOpen: NextPage = () => {
  return (
    <div className="w-80 flex flex-col items-start justify-start text-left text-base text-text-colors-gray font-body-text-normal-text">
      ...
      <div className="self-stretch bg-bg-colors-white flex flex-col items-start justify-center p-px text-sm border-r-[0.7px] border-solid border-slate-300 border-b-[0.7px] border-l-[0.7px]">
