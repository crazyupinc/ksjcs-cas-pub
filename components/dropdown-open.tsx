...
const DropdownOpen: NextPage = () => {
  return (
    <div className="w-80 flex flex-col items-start justify-start text-left text-base text-text-colors-gray font-navbar-sub-item">
      ...
      <div className="self-stretch bg-button-colors-white flex flex-col items-start justify-center p-px text-sm font-body-text-small-text border-r-[0.7px] border-solid border-colors-slate-300 border-b-[0.7px] border-l-[0.7px]">
