...
const MypageFeeDetail: NextPage = () => {
  return (
    <div className="w-[1920px] bg-bg-colors-white max-w-full flex flex-col items-center justify-start p-5 box-border text-left text-xl text-text-colors-gray font-headings-headling-2">
        ...
        <div className="self-stretch flex flex-col items-center justify-center pt-0 px-0 pb-10 gap-[36px] md:pb-10 md:box-border sm:pb-5 sm:box-border mq420:pb-5 mq420:box-border">
                  ...
                  <div className="flex-1 flex flex-row items-center justify-start py-0.5 px-0 gap-[80px] md:gap-[120px] md:items-center md:justify-start sm:flex-col sm:gap-[8px] mq420:flex-1 mq420:gap-[8px]">
                    ...
                    <div className="flex-1 flex flex-row items-center justify-start gap-[20px] md:flex-col md:gap-[4px] md:items-start md:justify-center md:pl-0 md:box-border sm:items-center sm:justify-center sm:flex-[unset] sm:self-stretch">
                      ...
                      <div className="flex flex-col items-end justify-start py-0 pr-0 pl-5 sm:items-center sm:justify-start sm:pl-0 sm:box-border mq420:pl-0 mq420:box-border">
                        <button className="cursor-pointer py-1.5 px-4 bg-[transparent] rounded-md overflow-hidden flex flex-row items-center justify-center border-[1px] border-solid border-text-hint-text hover:bg-gainsboro">
                          <div className="flex-1 relative text-xs leading-[16px] font-headings-headling-2 text-text-title-small text-center">
                            납부 취소 요청
                          </div>
                        </button>
                      </div>
              ...
              <div className="self-stretch overflow-hidden flex flex-col items-start justify-center min-w-[200px] hover:bg-bg-light lg:bg-bg-colors-white sm:flex-col">
                <div className="self-stretch flex flex-row items-center justify-start py-2.5 px-5 border-b-[1px] border-solid border-bg-light-border sm:flex sm:flex-row sm:pl-2 sm:pr-2 sm:box-border mq420:pl-2 mq420:pr-2 mq420:box-border">
                  <div className="flex-1 flex flex-row items-center justify-start py-0.5 px-0 gap-[80px] md:gap-[80px] sm:flex-col sm:gap-[8px] mq420:gap-[8px]">
                    ...
                    <div className="flex-1 flex flex-col items-start justify-start text-dark-gray font-text-medium sm:flex-[unset] sm:self-stretch">
                      <div className="self-stretch flex flex-col items-start justify-start gap-[6px]">
                        ...
                        <div className="self-stretch relative text-xs leading-[16px] font-headings-headling-2 text-semantic-warning mq420:text-2xs">
          ...
          <div className="flex flex-row items-center justify-center gap-[16px]">
            <button className="cursor-pointer [border:none] py-3.5 px-7 bg-button-colors-dark-sky rounded-md overflow-hidden flex flex-row items-center justify-center hover:bg-royalblue sm:py-2.5 sm:px-4 sm:box-border">
              <div className="relative text-base leading-[24px] font-headings-headling-2 text-bg-colors-white text-center sm:text-smi mq420:text-smi">
                입금 확인 요청
              </div>
            </button>
            <button className="cursor-pointer py-3.5 px-7 bg-[transparent] w-[156px] rounded-md box-border overflow-hidden shrink-0 flex flex-row items-center justify-center border-[1px] border-solid border-text-hint-text hover:bg-gainsboro sm:w-[120px] sm:py-2.5 sm:px-4 sm:box-border">
              <div className="relative text-base leading-[24px] font-headings-headling-2 text-text-title-small text-center sm:text-smi">
                목록으로
              </div>
            </button>
          </div>
