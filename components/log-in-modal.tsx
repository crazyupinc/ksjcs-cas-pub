...
const LogInModal: NextPage<LogInModalType> = ({ className = "" }) => {
  return (
    <div
      className={`shadow-[0px_3px_16px_rgba(0,_0,_0,_0.08)] rounded-lg bg-bg-white overflow-hidden flex flex-col items-center justify-start py-2 px-0 box-border relative min-w-[320px] max-w-[400px] text-left text-sm text-text-text-small-light font-headings-heading-3 ${className}`}
    >
      <img
      ...
      <div className="w-full flex flex-col items-start justify-start p-6 box-border gap-[20px] min-w-[320px] max-w-[400px] z-[1]">
        ...
        <Button buttonAlignSelf="stretch" button="로그인" />
