...
const LogInModal: NextPage<LogInModalType> = ({ className = "" }) => {
  return (
    <div
      className={`shadow-[0px_3px_16px_rgba(0,_0,_0,_0.08)] rounded-lg bg-button-colors-white overflow-hidden flex flex-col items-center justify-start py-2 px-0 box-border relative min-w-[320px] max-w-[400px] text-left text-sm text-text-text-small-light font-sub-banner-title ${className}`}
    >
      <img
      ...
      <div className="w-full flex flex-col items-start justify-start p-6 box-border gap-[20px] min-w-[320px] max-w-[400px] z-[1]">
        <div className="self-stretch flex flex-col items-start justify-start gap-[14px]">
          ...
          <div className="flex flex-row items-center justify-start gap-[8px]">
            <div className="w-4 relative bg-button-colors-white box-border h-4 border-[1px] border-solid border-colors-slate-400" />
