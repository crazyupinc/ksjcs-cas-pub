  ...
  return (
    ...
    >
      ...
      <div className="self-stretch bg-colors-cyan-950 h-10 flex flex-row items-center justify-between py-3 px-2.5 box-border mq420:h-10">
        <button className="cursor-pointer [border:none] p-0 bg-[transparent] relative text-xs leading-[16px] font-headings-heading-3 text-bg-white text-left inline-block">{`하루 동안 다시 열지않습니다 `}</button>
