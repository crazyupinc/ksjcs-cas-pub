...
const GalleryCard: NextPage<GalleryCardType> = ({
  ...
  return (
    <div
      className={`rounded bg-bg-light box-border overflow-hidden flex flex-col items-center justify-start text-left text-sm text-text-text-small-light font-sub-banner-title flex-1 border-[1px] border-solid border-bg-light-border hover:animate-[0.2s_ease-in_0s_1_normal_forwards_custom-animation] hover:opacity-[1] ${className}`}
    >
      <img
