...
const TableBbsHeaderRow: NextPage<TableBbsHeaderRowType> = ({
  ...
  return (
    <div
      className={`max-w-full overflow-hidden flex flex-col items-start justify-center min-w-[300px] text-center text-sm text-text-title-small font-sub-banner-title self-stretch ${className}`}
    >
