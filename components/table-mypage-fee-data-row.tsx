...
const TableMypageFeeDataRow: NextPage = () => {
  return (
    <div className="w-[1300px] max-w-full overflow-hidden flex flex-col items-start justify-center min-w-[200px] text-center text-sm text-text-title-small font-headings-headling-2 hover:bg-bg-light lg:bg-bg-light md:hover:bg-bg-light sm:flex-col">
