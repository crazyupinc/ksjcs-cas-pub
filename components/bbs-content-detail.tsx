...
export type BbsContentDetailType = {
  className?: string;
};

const BbsContentDetail: NextPage<BbsContentDetailType> = ({
  className = "",
}) => {
  return (
    <div
    ...
    >
      <div className="self-stretch flex flex-col items-center justify-center pt-0 px-0 pb-10">
        <div className="w-full h-[820px] flex flex-col items-end justify-center gap-[8px] max-w-[1300px]">
          ...
          <div className="self-stretch bg-bg-light box-border overflow-hidden flex flex-col items-end justify-center py-[21px] px-5 gap-[8px] min-w-[320px] text-right text-sm text-button-colors-dark-sky border-b-[1px] border-solid border-bg-light-border hover:bg-bg-light sm:flex-col sm:gap-[8px] sm:items-start sm:justify-center mq420:min-w-[200px]">
            <div className="self-stretch overflow-hidden flex flex-row items-center justify-end gap-[8px] sm:pt-0 sm:pb-0 sm:box-border">
              <img
                className="w-5 relative h-5 overflow-hidden shrink-0"
                alt=""
                src="/iconfiletext.svg"
              />
              <div className="relative leading-[20px] overflow-hidden text-ellipsis whitespace-nowrap">
                [한국PR학회] 한국PR학생회 설립 및 참여요청 안내 0505
              </div>
              <div className="relative leading-[20px] text-text-hint-text overflow-hidden text-ellipsis whitespace-nowrap">
                (653.98 KB)
              </div>
            </div>
            <div className="self-stretch overflow-hidden flex flex-row items-center justify-end gap-[8px] sm:pt-0 sm:pb-0 sm:box-border">
          ...
          <div className="self-stretch flex flex-row items-center justify-start border-t-[1px] border-solid border-colors-cyan-950">
            ...
            <div className="flex-1 box-border overflow-hidden flex flex-row items-center justify-start py-3 px-5 gap-[20px] min-w-[320px] border-b-[1px] border-solid border-bg-light-border hover:bg-bg-light mq420:pl-2 mq420:box-border mq420:min-w-[200px]">
              <div className="flex-1 overflow-hidden flex flex-row items-start justify-start gap-[20px] sm:pt-0 sm:pb-0 sm:box-border">
                <div className="relative leading-[20px] inline-block min-w-[40px] sm:hidden">
                  819
                </div>
                <div className="flex-1 relative leading-[24px] text-button-colors-dark-sky text-left overflow-hidden text-ellipsis whitespace-nowrap">{`2024 봄철 정기학술대회 특별기획세션 발제자 선정 결과 안내 `}</div>
              </div>
          ...
          <div className="self-stretch flex flex-row items-center justify-start">
            ...
            <div className="flex-1 box-border overflow-hidden flex flex-row items-center justify-start py-3 px-5 gap-[20px] min-w-[320px] border-b-[1px] border-solid border-bg-light-border hover:bg-bg-light mq420:pl-2 mq420:box-border mq420:min-w-[200px]">
              <div className="flex-1 overflow-hidden flex flex-row items-start justify-start gap-[20px] sm:pt-0 sm:pb-0 sm:box-border">
                ...
                <div className="flex-1 relative leading-[24px] text-button-colors-dark-sky text-left overflow-hidden text-ellipsis whitespace-nowrap">{`2024 봄철 정기학술대회 특별기획세션 발제자 선정 결과 안내 <무너진 구매 경로(Funnel): 새로운 마케팅 새로운 마케팅 커뮤니케이션 패러다임의 도래> 2024 봄철 정기학`}</div>
              </div>
              <div className="flex flex-row items-center justify-start py-1 px-0 text-text-text-small sm:hidden sm:gap-[20px] sm:pt-0 sm:pb-0 sm:box-border">
                <div className="w-[120px] flex flex-row items-center justify-center sm:w-auto sm:[align-self:unset]">
                  <div className="relative leading-[20px] sm:text-left">
...
export default BbsContentDetail;
