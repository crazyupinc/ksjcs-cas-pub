...
const Footer: NextPage = () => {
  return (
    <div className="w-[1920px] bg-text-colors-dark-gray max-w-full flex flex-col items-center justify-start p-2.5 box-border text-center text-17xl text-text-colors-amber font-headings-heading-3">
